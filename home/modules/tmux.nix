{ config, ... }: {
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      bind r source-file "${config.home.homeDirectory}/.config/tmux/tmux.conf" \; display "Configuration Reloaded!"
      ...
      run "${config.home.homeDirectory}/.config/tmux/plugins/tpm/tpm"
    '';
  };
}
